...
function _classCallCheck(instance, Constructor) {
    ...
    API.autoTable = function(headers, data, options) {
        ...
        calculateWidths();
        var firstRowHeight = table.rows[0] && settings.pageBreak === "auto" ? table.rows[0]
            .height : 0;
        ...
        if (settings.pageBreak === "always" && settings.startY !== false || settings.startY !==
            false && minTableBottomPos > doc.internal.pageSize.height) {
            doc.addPage();
    ...
    API.autoTableText = function(text, x, y, styles) {
        ...
        var lineCount = 1;
        if (styles.valign === "middle" || styles.valign === "bottom" || styles.halign ===
            "center" || styles.halign === "right") {
        ...
        if (styles.halign === "center" || styles.halign === "right") {
            ...
            if (lineCount >= 1) {
                for (var iLine = 0; iLine < splittedText.length; iLine++) {
                    doc.text(splittedText[iLine], x - doc.getStringUnitWidth(splittedText[
                        iLine]) * alignSize, y);
                    y += fontSize
                }
                return doc
    ...
    function initOptions(userOptions) {
        ...
        if (typeof marginSetting.vertical === "number") {
            ...
            if (typeof marginSetting === "number") {
                ...
                settings.margin[side] = typeof marginSetting[key] === "number" ?
                    marginSetting[key] : 40
            }
        });
        return settings
    }
    ...
    function createModels(inputHeaders, inputData) {
        ...
        headerRow.index = -1;
        var themeStyles = extend(defaultStyles, themes[settings.theme].table, themes[settings.theme]
            .header);
        ...
        inputHeaders.forEach(function(rawColumn, dataKey) {
            ...
            cell.text = "" + cell.raw;
            cell.contentWidth = cell.styles.cellPadding * 2 + getStringWidth(cell.text,
                cell.styles);
        ...
        inputData.forEach(function(rawRow, i) {
            ...
            var userStyles = extend(settings.styles, settings.bodyStyles, isAlternate ?
    ...
    function calculateWidths() {
        ...
        var maxTableWidth = doc.internal.pageSize.width - settings.margin.left - settings.margin
            .right;
        ...
        all.forEach(function(row, i) {
            ...
            table.columns.forEach(function(col) {
                ...
                } else if (cell.styles.overflow === "visible") {} else if (cell
            ...
            row.height = row.heightStyle + lineBreakCount * row.styles.fontSize *
                FONT_ROW_RATIO;
    ...
    function distributeWidth(dynamicColumns, staticWidth, dynamicColumnsContentWidth, fairWidth) {
        ...
        for (var i = 0; i < dynamicColumns.length; i++) {
            ...
            if (extraWidth < 0 && isNoneDynamic) {
                ...
                distributeWidth(dynamicColumns, staticWidth, dynamicColumnsContentWidth,
                    fairWidth);
                break
            } else {
